	...
	<body style="background-image:url(/storage/app/public/background.jpg); ">
		<div class="wrapper">
			...
			<div class="footer">
				...
				<div @if(!Storage::disk('public')->exists('background.jpg')) style="overflow:hidden;height:80px;background:url('/public/elements-img/patterns/optimised.svg') 0 -30px repeat-x;background-size:auto 794px" @endif class="footer_green">
				</div>	
			</div> <!-- footer -->
		</div>
