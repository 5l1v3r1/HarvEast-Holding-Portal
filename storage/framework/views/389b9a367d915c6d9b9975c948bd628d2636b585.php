        ...
        <div class="side-menu-container">
                ...
                <a class="navbar-brand" href="<?php echo e(route('voyager.dashboard')); ?>">
                    <div class="logo-icon-container">
                        ...
                        <?php if($admin_logo_img == ''): ?>
                            <img src="<?php echo e(voyager_asset('images/harveast_logo.png')); ?>" alt="Logo Icon">
                        <?php else: ?>
                            <img src="<?php echo e(Voyager::image($admin_logo_img)); ?>" alt="Logo Icon">
                        <?php endif; ?>
                    </div>
                    <div class="title"><?php echo e(Voyager::setting('admin_title', 'HARVEAST')); ?></div>
                </a>
            </div><!-- .navbar-header -->
            ...
            <div class="panel widget center bgimage"
                ...
                <div class="panel-content">
                    <img src="<?php echo e(Auth::user()->photo); ?>" class="avatar" alt="<?php echo e(Auth::user()->name); ?> avatar">
