...
<?php if(isset($dataTypeContent->id)): ?>
    <?php $__env->startSection('page_title','Редактирвать '.$dataType->display_name_singular); ?>
<?php else: ?>
    <?php $__env->startSection('page_title','Добавить '.$dataType->display_name_singular); ?>
<?php endif; ?>

<?php $__env->startSection('page_header'); ?>
    <h1 class="page-title">
        <i class="<?php echo e($dataType->icon); ?>"></i> <?php if(isset($dataTypeContent->id)): ?><?php echo e('Редактировать'); ?><?php else: ?><?php echo e('Добавить'); ?><?php endif; ?> <?php echo e($dataType->display_name_singular); ?>
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-bordered">
                    ...
                    <div class="panel-heading">
                        <h3 class="panel-title"><?php if(isset($dataTypeContent->id)): ?><?php echo e('Редактировать'); ?><?php else: ?><?php echo e('Добавить'); ?><?php endif; ?> <?php echo e($dataType->display_name_singular); ?></h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form role="form"
