...
class DataRowsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $positionDataType = DataType::where('slug', 'positions')->firstOrFail();
        $departmentDataType = DataType::where('slug', 'departments')->firstOrFail();
        $pollDataType = DataType::where('slug', 'polls')->firstOrFail();

        $this->short($cityDataType);
        $this->short($positionDataType);
        $this->short($departmentDataType);
        $this->short($pollDataType);
        }
    }
    ...
    public function short($dataType)
    {
