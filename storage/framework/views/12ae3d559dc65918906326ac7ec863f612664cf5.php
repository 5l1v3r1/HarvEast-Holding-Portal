...
<head>
    ...
    <!-- Few Dynamic Styles -->
    <style type="text/css">
        .flat-blue .side-menu, .widget .btn-primary, .widget .btn-primary:focus, .widget .btn-primary:hover, .widget .btn-primary:active, .widget .btn-primary.active, .widget .btn-primary:active:focus{
...
<div id="voyager-loader">
    ...
    <?php if($admin_loader_img == ''): ?>
        <img src="<?php echo e(voyager_asset('images/harveast_logo.png')); ?>" alt="Voyager Loader">
    <?php else: ?>
