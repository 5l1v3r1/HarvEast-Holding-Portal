...
$style = [
    ...
    'email-wrapper' => 'width: 100%; margin: 0; padding: 0; background-color: #126429;',
                                                ...
                                                <tr>
                                                    <td style="<?php echo e($fontFamily); ?>">
                                                        <p style="<?php echo e($style['paragraph-sub']); ?>">
                                                            Если возникли проблемы с нажатием на кнопку "<?php echo e($actionText); ?>",
                                                            скопируйте и вставьте URL ниже в ваш браузер:
                                                        </p>
