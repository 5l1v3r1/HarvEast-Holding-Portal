                ...
                <div class="panel panel-bordered">
                    <div class="panel-body table-responsive">
                        ...
                        <?php if(isset($dataType->server_side) && $dataType->server_side): ?>
                            <div class="pull-left">
                                <div role="status" class="show-res" aria-live="polite"><?php echo e($dataTypeContent->firstItem()); ?> - <?php echo e($dataTypeContent->lastItem()); ?> из <?php echo e($dataTypeContent->total()); ?></div>
                            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"><i class="voyager-trash"></i> Вы уверены, что хотите удалить <?php echo e(strtolower($dataType->display_name_singular)); ?>?</h4>
                </div>
