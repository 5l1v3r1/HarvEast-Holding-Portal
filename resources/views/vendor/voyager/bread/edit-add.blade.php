...
@if(isset($dataTypeContent->id))
    @section('page_title','Редактирвать '.$dataType->display_name_singular)
@else
    @section('page_title','Добавить '.$dataType->display_name_singular)
@endif

@section('page_header')
    <h1 class="page-title">
        <i class="{{ $dataType->icon }}"></i> @if(isset($dataTypeContent->id)){{ 'Редактировать' }}@else{{ 'Добавить' }}@endif {{ $dataType->display_name_singular }}
    </h1>
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-bordered">
                    ...
                    <div class="panel-heading">
                        <h3 class="panel-title">@if(isset($dataTypeContent->id)){{ 'Редактировать' }}@else{{ 'Добавить' }}@endif {{ $dataType->display_name_singular }}</h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form role="form"
