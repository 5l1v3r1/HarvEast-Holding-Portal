        ...
        <div class="navbar-header">
            ...
            <ol class="breadcrumb hidden-xs">
                <?php if(count(Request::segments()) == 1): ?>
                    <li class="active"><i class="voyager-boat"></i> Главная страница</li>
                <?php else: ?>
                    <li class="active">
                        <a href="<?php echo e(route('voyager.dashboard')); ?>"><i class="voyager-boat"></i> Главная страница</a>
                    </li>
                <?php endif; ?>
                <?php $breadcrumb_url = ''; ?>
        ...
        <ul class="nav navbar-nav navbar-right">
            <li class="dropdown profile">
                <a href="#" class="dropdown-toggle text-right" data-toggle="dropdown" role="button"
                   aria-expanded="false"><img src="<?php echo e(Auth::user()->photo); ?>" class="profile-img"> <span
                            class="caret"></span></a>
                <ul class="dropdown-menu dropdown-menu-animated">
                    <li class="profile-img">
                        <img src="<?php echo e(Auth::user()->photo); ?>" class="profile-img">
