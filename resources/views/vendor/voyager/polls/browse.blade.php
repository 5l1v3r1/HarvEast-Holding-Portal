                        ...
                        <table id="dataTable" class="table table-hover">
                            ...
                            @foreach($dataTypeContent as $data)
                                <tr>
                                    ...
                                    <td>@if($data->isComplete()) Завершен @else Не завершен @endif</td>
                                    <td>{{ \Carbon\Carbon::parse($data->end)->format('F jS, Y h:i A') }}</td>
                                    <td class="no-sort no-click">                                    
                                        ...
                                        @if (Voyager::can('read_'.$dataType->name))
                                            <a href="/admin/polls/{{$data->id}}" class="btn-sm btn-warning pull-right">
