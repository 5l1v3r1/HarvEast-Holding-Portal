                ...
                <div class="panel panel-bordered">
                    <div class="panel-body table-responsive">
                        ...
                        @if (isset($dataType->server_side) && $dataType->server_side)
                            <div class="pull-left">
                                <div role="status" class="show-res" aria-live="polite">{{ $dataTypeContent->firstItem() }} - {{ $dataTypeContent->lastItem() }} из {{ $dataTypeContent->total() }}</div>
                            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"><i class="voyager-trash"></i> Вы уверены, что хотите удалить {{ strtolower($dataType->display_name_singular) }}?</h4>
                </div>
